...
import com.mysite.sbb.domain.question.form.QuestionForm;
...
//        List<AnswerDTO> answerList = answerService.getListByQuestion(id);
//        model.addAttribute("answerList", answerList);
    ...
    public String questionModify(@Valid QuestionForm questionForm, BindingResult bindingResult,
        ...
        questionService.modify(question.id(), questionForm.getSubject(), questionForm.getContent());
    ...
    @PreAuthorize("isAuthenticated()")
    @GetMapping("/vote/{id}")
    public String questionVote(Principal principal, @PathVariable("id") Long questionId) {
